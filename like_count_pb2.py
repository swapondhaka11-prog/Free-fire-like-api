...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_BASICINFO']._serialized_end=127
  _globals['_INFO']._serialized_start=129
  _globals['_INFO']._serialized_end=168
